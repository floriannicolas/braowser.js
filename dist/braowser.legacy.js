var Braowser = (() => {
  ...
  var DEVICE_PATTERNS = [
    ...
    [/Android.*\bMobile\b/, () => ({ vendor: void 0, model: void 0, type: "mobile" })],
    [/Android/, () => ({ vendor: void 0, model: void 0, type: "tablet" })],
    // Non-Android mobile devices (BlackBerry, old feature phones, …).
    [MOBILE_REGEX_A, () => ({ vendor: void 0, model: void 0, type: "mobile" })]
  ];
  var CPU_PATTERNS = [
  ...
  function findBrandVersion(brands, browserName) {
    var _a;
    const wanted = (_a = BROWSER_TO_BRAND[browserName]) != null ? _a : browserName.toLowerCase();
  ...
  var Braowser = class {
    ...
    getDevice() {
      var _a;
      const base = (_a = matchFirst(this._ua, DEVICE_PATTERNS)) != null ? _a : { vendor: void 0, model: void 0, type: void 0 };
      return base.model === "Macintosh" && looksLikeIpad() ? { vendor: "Apple", model: "iPad", type: "tablet" } : base;
    }
    /** @returns {ICPU} */
    getCPU() {
    ...
    getResultAsync() {
      return __async(this, null, function* () {
        ...
        if (Array.isArray(hints.fullVersionList) && result.browser.name) {
          ...
          if (brand) {
            result.browser = __spreadProps(__spreadValues({}, result.browser), { version: brand.version, major: majorOf(brand.version) });
